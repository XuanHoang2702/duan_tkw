...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!array_filter($errors)) {
        $sql = "UPDATE hang_hoa SET ma_hh='$ma_hh',ten_hh='$ten_hh',don_gia='$don_gia',giam_gia='$giam_gia',hinh_anh='$hinh_anh',ngay_nhap='$ngay_nhap',mo_ta='$mo_ta',dac_biet='$dac_biet',so_luot_xem='$so_luotxem',ma_loai='$ma_loai' where ma_hh=$ma_hh";
...
//lấy dữ liệu bảng hàng hóa
$ma = $_GET['ma_hh'];
$sql = "SELECT * FROM hang_hoa where ma_hh=$ma";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
<body>
    <div class="container">
        ...
        <h2 style="margin-top:20px ;" class="alert alert-success">Sửa hàng hóa</h2>
        <form action="" method="post" enctype="multipart/form-data">
            <div class="list-group">
                <div class="group">
                    <div class="ma_hh">
                        <label for="">mã hàng hóa</label>
                        <input style="background-color:	#DCDCDC;" type="text" name="ma_hh" value="<?= $hang['ma_hh'] ?>">
                    </div>
                    <div class="giam_gia">
                        <label for="">Giảm giá</label>
                        <input type="number" name="giam_gia" value="<?= $hang['giam_gia']  ?>">
                        <br>
                ...
                <div class="group">
                    <div class="ten_hanghoa">
                        ...
                        <input type="text" name="ten_hh" value="<?= $hang['ten_hh']  ?>">
                        <br>
                    ...
                    <div class="hinh_anh">
                        ...
                        <input type="hidden" name="hinh_anh" value="<?= $hang['hinh_anh'] ?>">
                        <span style="color: black;">(<?= $hang['hinh_anh'] ?>)</span>
                        <br>

                    </div>
                    <div class="ngay_nhap">
                        <label for="">Ngày nhập</label>
                        <input type="date" name="ngay_nhap" value="<?= $hang['ngay_nhap'] ?>">
                        <br>
                ...
                <div class="group">
                    <div class="don_gia">
                        ...
                        <input type="number" name="don_gia" value="<?= $hang['don_gia'] ?>">
                        <br>
                    ...
                    <div class="loai_hang">
                        ...
                        <select name="ma_loai">
                            <?php foreach ($loai as $l) : ?>
                                <?php if ($l['ma_loai'] == $hang['ma_loai']) : ?>
                                    <option selected value="<?= $l['ma_loai'] ?>">
                                        <?= $l['ten_loai'] ?>
                                    </option>
                                <?php else : ?>
                    ...
                    <div class="so_luotxem">
                        ...
                        <input style="background-color:	#DCDCDC;" type="text" name="luot_xem" value="<?= $hang['so_luot_xem'] ?>" readonly>
                        <br>
            ...
            <div class="mota">
                ...
                <textarea name="mota" id="" cols="147" rows="5"><?= $hang['mo_ta'] ?></textarea>
            </div>
            <div class="btn">
